            ...
            return OrientationBuilder(builder: (context, orientation) {
              ...
              return BlocConsumer<ProductsCubit, ProductsState>(
                ...
                if (state is ProductsFetchFailure) {
                  return Scaffold(
                    appBar: CustomAppbar(titleKey: '',showBackButton: true,),
                    body: ErrorScreen(
    ...
    return GestureDetector(
      onTap: () {
        Utils.navigateToScreen(context, Routes.productDetailsScreen,
            arguments: ProductDetailsScreen.buildArguments(product: prdct,productIds: [prdct.id!],storeId: widget.storeId??context.read<StoresCubit>().getDefaultStore().id!),
