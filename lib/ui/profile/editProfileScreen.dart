...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void setFormFieldValues() {
    Future.delayed(Duration.zero, () {
      ...
      // Set country code from user details if available
      final userDetails = (context.read<UserDetailsCubit>().state as UserDetailsFetchSuccess?)?.userDetails;
      if (userDetails?.countryCode != null && userDetails!.countryCode!.isNotEmpty) {
        _countryCode = '+${userDetails.countryCode!}';
      }
  ...
  formWidget() {
    return Form(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          // Phone number field with country code picker when editable
          context.read<AuthCubit>().getUserDetails().type == phoneLoginType
              ? CustomTextFieldContainer(
                  labelKey: phoneNumberKey,
                  hintTextKey: phoneNumberKey,
                  readOnly: true,
                  textEditingController:TextEditingController(text: '${_countryCode} ${controllers[phoneNumberKey]!.text}'),
                    ...
                    if (state is! UpdateUserFetchInProgress) {
                      if (_formKey.currentState!.validate()) {
                        Map<String, dynamic> params = {
                          ...
                          ApiURL.countryCodeApiKey: _countryCode.toString().replaceAll('+', ''),
                        };
