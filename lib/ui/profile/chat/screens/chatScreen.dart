...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen(
      {Key? key, required this.id,this.userName ,required this.isTicketChatScreen})
      : super(key: key);
    ...
    return PopScope(
      ...
      child: BlocConsumer<SendMessageCubit, SendMessageState>(
        ...
        if (state is SendMessageSuccess) {
          _controller.clear();
          _selectedfiles = null;
          // Emit success state in GetMessageCubit instead of directly updating UI
        ...
        return BlocConsumer<GetMessageCubit, GetMessageState>(
          ...
          return Scaffold(
              ...
              body: state is GetMessageInProgress
                  ...
                  : state is GetMessageSuccess && state.messages.isEmpty
                      ? _buildNoDataWidget()
                      : state is GetMessageSuccess
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: state.messages.reversed.length,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              bool showLabel = isAdmin &&
                                  (reversedIndex == 0 ||
                                      !(messages[reversedIndex - 1].fromId !=
                                          AuthRepository.getUserDetails().id));
                              return MessageItem(
                                  message: message,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Subtitle message
              CustomTextContainer(
                textKey: widget.isTicketChatScreen 
                    ? askYourQueryKey 
                    : sendFirstMessageKey,
                textAlign: TextAlign.center,
                style: Theme.of(context)
