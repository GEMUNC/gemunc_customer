  ...
  doPaymentWithRazorpay(
    ...
    try {
      ...
      var response = await TransactionRepository()
          .createRazorpayOrder(orderID: orderID, amount: price * 100);
...
if(callAddTransactionApi ){
  ...
  transactionAdded = await addTransaction(params: params);
}
else{
  transactionAdded=true;
      ...
      bool isPhonePeInitilized = await PhonePePaymentSdk.init(
          phonePeDetails[ApiURL.dataKey]['environment']??'Sandbox',
          merchantId,
